const projectsData = [
  ...
  },
  {
    ...
    description:
      'An e-commerce sneakers store with a modern product catalog, filtering, and responsive design.',
    image: 'img/image.png',
    alt: 'Sneakers Store',
    tags: ['React', 'Tailwind CSS', 'Vite', 'React Router'],
    demo: 'https://sneakers-tau-jet.vercel.app',
    code: 'https://github.com/meriem-es-sadik/sneakers',
  },
];
